...
public class ITXmlHelperTests1 {
    private static final Logger LOG = LoggerFactory.getLogger(ITXmlHelperTests1.class);
    ...
    public void convertStringToXmlAndBack() throws Exception {
      ...
      LOG.info("this is sample integration testing");
  }
}
