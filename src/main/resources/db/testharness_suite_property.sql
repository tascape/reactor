...
--
-- Dumping data for table `suite_property`
--

LOCK TABLES `suite_property` WRITE;
/*!40000 ALTER TABLE `suite_property` DISABLE KEYS */;
/*!40000 ALTER TABLE `suite_property` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-04-28  5:59:43
